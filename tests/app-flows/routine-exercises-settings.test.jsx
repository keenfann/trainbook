...
describe('App UI flows', () => {
  ...
  it('reorders supersets as a block in routine list controls', async () => {
    const routine = {
      ...
      updatedAt: new Date().toISOString(),
      exercises: [
        { id: 1, exerciseId: 11, name: 'Bench Press', primaryMuscles: ['chest'], equipment: 'Barbell', position: 0, targetSets: 2, targetReps: 8, targetRestSeconds: 60, targetWeight: 80, targetBandLabel: null, notes: null, supersetGroup: 'g1' },
        { id: 2, exerciseId: 12, name: 'Pendlay Row', primaryMuscles: ['lats'], equipment: 'Barbell', position: 1, targetSets: 2, targetReps: 8, targetRestSeconds: 60, targetWeight: 60, targetBandLabel: null, notes: null, supersetGroup: 'g1' },
        { id: 3, exerciseId: 13, name: 'Split Squat', primaryMuscles: ['quadriceps'], equipment: 'Dumbbell', position: 2, targetSets: 2, targetReps: 10, targetRestSeconds: 90, targetWeight: 20, targetBandLabel: null, notes: null, supersetGroup: null },
      ],
    };
